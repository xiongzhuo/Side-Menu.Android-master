...
import activity.xz.com.mylibrary.model.SlideMenuItem;
import activity.xz.com.mylibrary.util.ViewAnimator;
...
//        observer1.subscribe(observer);
    ...
    private ScreenSettable replaceFragment(ScreenSettable screenShotable, int topPosition) {
    ...
    @Override
    public ScreenSettable onSwitch(Resourceble slideMenuItem, ScreenSettable screenShotable, int position) {
